...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: A person was added in the begging of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: After apply GetNextPerson(), and the turn was < 1, person was not enqueue again.
    ...
    // Defect(s) Found: No defects, It was working as default version.
